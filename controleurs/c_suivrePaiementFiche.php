...
$dateActuelle= substr(dateAnglaisVersFrancais(dateActuelle()), 3, 7);           //Récupération de la date actuelle au format mm/aaaa aprés conversion au format FR
 

if(isset($_POST['visiteurs'])){
    foreach($_POST['visiteurs'] as $i => $infosFiche){
        $idFiche = explode('|', $infosFiche);                                     //Reconstitution de l'identifiant de la fiche
...
// Concaténation de tableaux pour éviter de créer une requête sql spécifique
